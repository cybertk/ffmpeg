...
def CleanObjectFiles(object_files):
  ...
  blacklist = [
      ...
      'libswresample/log2_tab.o',  # Includes libavutil/log2_tab.c
      'libavcodec/audioconvert.o',  # Includes libswresample/audioconvert.c
      ...
      # TODO(kyan): movenc.cp depends on SDP.
      #'libavformat/sdp.o',
      'libavutil/adler32.o',
      'libavutil/aes.o',
      'libavutil/des.o',
...
def main():
  ...
  for arch in SUPPORTED_ARCHITECTURES:
    for target in SUPPORTED_TARGETS:
      for platform in SUPPORTED_PLATFORMS:
        ...
        s = set()
        for name in  GetSourceFileSet(object_to_sources, object_files):
            s.add(NormalizeFilename(os.path.join(options.source_dir, name)))
  ...
  for root, dirnames, filenames in os.walk('.'):
    ...
    if not root.startswith(('libavcodec', 'libavutil', 'libavformat', 'libswscale', 'libswresample')):
      continue
