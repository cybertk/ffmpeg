...
#define FFMPEG_CONFIGURATION "--disable-everything --disable-avdevice --disable-avfilter --disable-bzlib --disable-doc --disable-ffprobe --disable-lzo --disable-network --disable-postproc --disable-zlib --enable-fft --enable-rdft --enable-shared --disable-programs --disable-hwaccels --enable-hwaccel=h264_vda --disable-dxva2 --disable-vaapi --disable-vda --disable-vdpau --optflags=-O2 --arch=i686 --enable-yasm --extra-cflags=-m32 --extra-ldflags=-m32 --enable-pic --enable-protocol=file --enable-encoder=libx264 --enable-encoder=libfaac --enable-muxer=mp4 --enable-muxer=rtp --enable-libx264 --enable-gpl --enable-libfaac --enable-nonfree"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define FFMPEG_DATADIR "/usr/local/share/ffmpeg"
#define AVCONV_DATADIR "/usr/local/share/ffmpeg"
#define CC_IDENT "gcc 4.7.0 (GCC) 20120414 (prerelease)"
